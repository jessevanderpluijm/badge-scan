...
export const EVENT_TYPES_NL: Record<string, EventType> = {
  "trade-shows": {
    ...
    description:
      "Beurzen betekenen onvoorspelbare walk-ins, last-minute standpersoneel en de noodzaak om er vanaf de eerste minuut verzorgd uit te zien. PrintBadges print duidelijke, gebrande bezoekersbadges bij de ingang — geen mail-merge de avond ervoor, geen voorgedrukte verspilling, geen spreadsheetacrobatiek. Gemaakt voor organisatoren van beurzen en B2B-expo's.",
    audience:
    ...
    whyBullets: [
      {
        ...
        body: "De helft van je bezoekers registreert zich bij de deur. PrintBadges behandelt ad-hocdeelnemers net als voorgeregistreerde: scan een QR of typ een barcode, print, klaar.",
      },
      {
        title: "Exposanten- + bezoekersbadges naast elkaar",
        body: "Draai twee evenementen in PrintBadges — één voor bezoekers, één voor standpersoneel — elk met een eigen ontwerp, deelnemerslijst en scannerpagina.",
      },
      {
    ...
    faq: [
      {
        q: "Kan PrintBadges 10.000+ beursbezoekers aan?",
      ...
      },
      {
        ...
        a: "Ja — en dat kan met PrintBadges. Maak twee aparte evenementen aan (bijv. 'Vakbeurs 2026 — Bezoekers' en 'Vakbeurs 2026 — Exposanten'), elk met een eigen ontwerp en scannerstation.",
      },
      {
      ...
      {
        q: "Is PrintBadges geschikt voor meerdaagse beurzen?",
  ...
  conferences: {
    ...
    description:
      "Conferenties staan of vallen met een soepele incheck. PrintBadges houdt de rij in beweging: scan ticket, print badge, geef hem mee. De standaard vlinderbadge met naam, functie en bedrijf is wat professionele conferentiebezoekers verwachten — en je ontwerpt hem zonder designer. Voor conferenties van elke omvang.",
    audience:
    ...
    whyBullets: [
      {
        ...
        body: "Deze vier velden zijn volwaardig in PrintBadges. De vlinderbadge toont ze in de indeling die conferentiebezoekers verwachten, met de juiste hiërarchie.",
      },
      {
        title: "Spreker- & VIP-badges",
        body: "Maak een tweede evenement in PrintBadges met een eigen ontwerp (andere achtergrondkleur, accentstreep). Zelfde workflow, ander uiterlijk.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Nee — PrintBadges is bewust organisatorgestuurd. Zo blijft de badge-indeling consistent en voorkom je misbruik (valse namen, eigen titels).",
      },
      {
        q: "Ondersteunt PrintBadges conferenties met meerdere tracks?",
  ...
  events: {
    ...
    description:
      "Workshops, meetups, bedrijfsevenementen, awardshows, klantendagen, interne bedrijfsbijeenkomsten — overal waar deelnemers een naam op hun borst nodig hebben, regelt PrintBadges het. Geen nieuwe tools, geen nieuwe training, geen inrichting per evenement. Voor evenementen van elke grootte.",
    audience:
    ...
    whyBullets: [
      ...
      },
      {
        ...
        body: "Geen app om te installeren, geen specifiek besturingssysteem. Heb je een browser, dan heb je PrintBadges. Neem de Epson C4000 mee die je locatie of AV-partner al levert.",
      },
    ],
    faq: [
      {
        q: "Is PrintBadges alleen voor grote evenementen?",
      ...
      },
      {
        ...
        a: "Ja — de scanner bevraagt PrintBadges live zodat ingetrokken tickets ingetrokken blijven. Zorg dat je locatie stabiele wifi of een bekabelde verbinding heeft.",
      },
      {
        q: "Kan ik PrintBadges gebruiken voor terugkerende evenementen?",
